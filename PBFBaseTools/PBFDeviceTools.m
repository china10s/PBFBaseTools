...
+ (instancetype)sharedInstance{
    static PBFDeviceTools *tools ;
    @synchronized(self){
        if (!tools) {
            tools = [[PBFDeviceTools alloc] initPrivate];
        }
    }
...
- (EnumPbfDeviceType)getDeviceEnumType{
    ...
    */
    ...
    BOOL isContain = [self containString:platform strKey:@"iPhone1"];
    if ([self containString:platform strKey:@"iPhone1"]||[self containString:platform strKey:@"iPhone2"])
        return DEVICETYPES_IPHONE3;
    if ([self containString:platform strKey:@"iPhone3"]||[self containString:platform strKey:@"iPhone4"])
        return DEVICETYPES_IPHONE4;
    if ([self containString:platform strKey:@"iPhone5"]||[self containString:platform strKey:@"iPhone6"])
        return DEVICETYPES_IPHONE5;
    if ([self containString:platform strKey:@"iPhone7"])
...
- (NSString*)getDeviceStringType{
    return [self doDevicePlatform];
}
