...
- (instancetype)initWithVerify:(PBFButtonVerifyCodeBlock)block{
    ...
    [self setBackgroundImage:[PBFConvert createImageWithColor:[PBFColorTools sharedInstance].redColorSystem] forState:UIControlStateNormal];
    //[self setBackgroundImage:[PBFConvert createImageWithColor:[PBFColorTools sharedInstance].grayColorSystem] forState:UIControlStateSelected];
