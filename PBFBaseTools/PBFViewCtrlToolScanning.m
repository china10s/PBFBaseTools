...
#import "PBFViewCtrlToolScanning.h"
#import <AVFoundation/AVFoundation.h>
#import "PBFViewTools.h"

@interface PBFViewCtrlToolScanning ()<AVCaptureMetadataOutputObjectsDelegate>
...
@implementation PBFViewCtrlToolScanning
//单例
+ (instancetype)sharedInstance{
    static PBFViewCtrlToolScanning *scanningTools = nil;
    @synchronized(self) {
        if (!scanningTools) {
            scanningTools = [[PBFViewCtrlToolScanning alloc] init];
        }
    }
    return scanningTools;
}
...
//- (UIButton*)btnBack{
//    if (!_btnBack) {
//        _btnBack = [[UIButton alloc] initWithFrame:CGRectMake(20, 40, 20, 10)];
//        [_btnBack addTarget:self action:@selector(clickBack:) forControlEvents:UIControlEventTouchUpInside];
//        [_btnBack setBackgroundImage:[UIImage imageNamed:@"ic_login_close.png"] forState:UIControlStateNormal];
//    }
//    return _btnBack;
//}
